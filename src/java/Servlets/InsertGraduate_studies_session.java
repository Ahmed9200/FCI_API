 ...
 * @author 20102
 */
@WebServlet(name = "InsertGraduate_studies_session", urlPatterns = ("/InsertGraduate_studies_session"))
@MultipartConfig(maxFileSize = 1024 * 1024 * 50)// 1.5 MB
public class InsertGraduate_studies_session extends HttpServlet {
